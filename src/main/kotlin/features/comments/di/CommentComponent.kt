...
class CommentComponent(
    ...
    val service: CommentService by lazy { CommentService(repository, postRepository, notificationService) }
    val likeService: CommentLikeService by lazy { CommentLikeService(likeRepository, repository, notificationService) }
}